/* author:  stephanie carbera & Matthew Alaniz
 *  description: a state where the mouse will noit moved unless given a signal on center sensor for more than 3 seconds, the mouse will than enter maze solving mode.
 *  data: 5/5/2019
 *  last edit: 5/18/2019
*/
